...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "users" | "events" | "registrations"
  ...
  export type eventsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "event_time" | "location" | "capacity", ExtArgs["result"]["events"]>
  ...
  export type registrationsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"user_id" | "event_id", ExtArgs["result"]["registrations"]>
  ...
  export interface registrationsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const registrationsWithUser_idOnly = await prisma.registrations.findMany({ select: { user_id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Registrations and only return the `user_id`
     * const registrationsWithUser_idOnly = await prisma.registrations.createManyAndReturn({
     *   select: { user_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Registrations and only return the `user_id`
     * const registrationsWithUser_idOnly = await prisma.registrations.updateManyAndReturn({
     *   select: { user_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface registrationsFieldRefs {
    readonly user_id: FieldRef<"registrations", 'String'>
  ...
  export type registrationsWhereInput = {
    ...
    user_id?: StringFilter<"registrations"> | string
  ...
  export type registrationsScalarWhereWithAggregatesInput = {
    ...
    user_id?: StringWithAggregatesFilter<"registrations"> | string
